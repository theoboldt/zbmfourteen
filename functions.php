...
*/
    wp_enqueue_script( 'twentyfourteen-script', get_stylesheet_directory_uri() . '/js/jquery.countdown.min.js', array( 'jquery' ), '20150412', true );
	wp_enqueue_script( 'twentyfourteen-script', get_stylesheet_directory_uri() . '/js/functions.js', array( 'jquery' ), '20140616', true );

}
add_action( 'wp_enqueue_scripts', 'zbmfourteen_scripts', 3);
